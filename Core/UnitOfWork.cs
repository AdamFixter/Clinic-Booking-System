namespace Core
{
    ...
    {
        #region Constants:
        private const string ConnectionString = "Server=(localdb)\\mssqllocaldb; Database=MiniBookingSystem;Integrated Security=True;";
        #endregion
        ...
        public static ISessionFactory CreateSessionFactory()
        {
            return Fluently.Configure()
                ...
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<AppointmentDurationDataClassMap>())
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<PatientDataClassMap>())
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<AppointmentTypeDataClassMap>())
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<AppointmentUrgencyDataClassMap>())
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<ClinicDataClassMap>())
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<ClinicSpecialtieDataClassMap>())
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<SpecialtieDataClassMap>())
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<AppointmentDataClassMap>())
